  ...
  return (
    <div
      className={cn(
        ...
        isLinkedToDeals && !isSelected && "border-l-[6px] border-l-walls-sky/40 hover:border-l-walls-sky/40",
      )}
      onClick={handleClick}
        ...
        <div className={cn(
          ...
          <Checkbox
            ...
            className={cn(
              ...
              "data-[state=checked]:bg-black data-[state=checked]:border-black data-[state=checked]:text-walls-yellow",

...
const CategoryTab = ({
  ...
  return (
    ...
    >
      ...
      {category.name}
      {unreadCount > 0 && (
        <span className="ml-2 text-xs rounded-full px-2 py-0.5 bg-walls-yellow text-black font-medium transition-colors duration-200">
          {unreadCount}
        </span>
      )}
      <div className={cn(
        "absolute left-0 h-[2px] bg-walls-yellow transition-all duration-300 -bottom-[1.5px] rounded-full",
        ...
        <div className="flex items-center gap-3">
          <Checkbox 
            ...
            className={cn(
              ...
              "data-[state=checked]:bg-walls-yellow data-[state=checked]:text-neutral-700 data-[state=checked]:shadow-[inset_0_2px_4px_rgba(0,0,0,0.15)]",

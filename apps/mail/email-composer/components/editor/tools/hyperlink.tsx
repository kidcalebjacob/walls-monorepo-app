    ...
    <Popover open={isOpen} onOpenChange={(open) => {
      ...
      >
        <div className="flex items-center gap-2">
          <div className="flex-1 min-w-0 rounded-lg bg-neutral-100 backdrop-blur-md shadow-inner border border-neutral-200/50 pl-0.5 pr-4 py-2 focus-within:border-walls-yellow focus-within:ring-2 focus-within:ring-walls-yellow/30 transition-all">
            <Input
              id="link-url"
              value={linkUrl}

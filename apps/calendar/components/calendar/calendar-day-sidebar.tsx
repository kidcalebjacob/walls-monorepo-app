          ...
          <ChromeFrame className="w-full" contentClassName="w-full">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button
                  type="button"
                  className="inline-flex h-10 w-full items-center justify-center gap-1.5 rounded-[10.5px] bg-white/55 px-4 text-sm font-medium text-kenoo-ink shadow-[inset_0_1px_0_rgba(255,255,255,0.75)] transition-colors hover:bg-white/75"
                >

...
interface AnimatedPaymentToastProps {
  message: string;
  description?: string;
  isSuccess: boolean;
}
    ...
    <div className="flex items-center gap-3">
      ...
      >
        ...
        <motion.div
          ...
          className={`absolute inset-0 rounded-full ${iconColor}`}
        />
        ...
        <motion.div
          ...
          className={`relative z-10 ${iconColor} rounded-full p-2`}
        >
      ...
      >
        <div className={`${sparkleColor} text-lg`}>✨</div>
      </motion.div>
    </div>
  );
};

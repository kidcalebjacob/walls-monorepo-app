...
export function AgentSidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "hidden md:flex shrink-0 flex-col overflow-hidden border-r border-neutral-200 bg-gray-50 transition-[width] duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]",
      ...
      {/* Mobile nav */}
      <nav className="md:hidden flex items-center gap-6 overflow-x-auto border-b border-neutral-200 bg-gray-50 px-6 py-4">
        {navItems.map((item) => (

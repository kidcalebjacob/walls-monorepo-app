            ...
            return (
              <DropdownMenuItem
                ...
                title={
                  hasAppAccess
                    ? undefined
                    : "This account does not have access to Partnerhub"
                }
              >
...
function accountIconTone(account: PartnerhubAccount) {

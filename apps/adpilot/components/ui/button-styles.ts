...
export const dangerButtonClass =
  "rounded-full border border-rose-300/70 bg-rose-50/80 px-5 font-medium tracking-tight text-rose-700 shadow-[inset_0_1px_2px_rgba(127,29,29,0.04)] backdrop-blur-xl transition-all duration-300 ease-in-out hover:bg-rose-50 hover:border-rose-400/70 active:scale-[0.98]";

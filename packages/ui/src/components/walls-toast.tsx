...
export function WallsToastContent({
  variant,
  title,
  description,
  icon: IconOverride,
}: WallsToastContentProps) {
  const { Icon: DefaultIcon, ripple, bg, color, sparkle } =
...
/** Mount once in app layout/providers — required for `wallsToast` to render. */
export function WallsToaster() {
  return <SonnerToaster position="bottom-right" expand richColors />;
}
